...
describe("AcademicYear test", () => {
  ...
  const academicYear = new AcademicYear("name", new Date("2023-02-17T10:00:00"), new Date("2023-02-17T10:00:00"), true, admin)
  ...
  expect(() => new AcademicYear("name", new Date("2023-02-17T10:00:00"), new Date("2023-02-17T10:00:00"), true, nonAdmin)).toThrow(new Error("Non admin cannot create academic year"))
  })
  ...
  const admin = new User("admin", "lastname", "name@email.com", "password", Role.admin)
  const academicYear = new AcademicYear("name", new Date("2023-02-17T10:00:00"), new Date("2023-02-17T10:00:00"), true, admin)
  const nonTeacher = new User("student", "lastname", "name@email.com", "password", Role.student)

  expect(() => academicYear.addTeacher(nonTeacher)).toThrow(new Error("Cannot add a non teacher"))
  })

  it("should add student to academic year", () => {
  const admin = new User("admin", "lastname", "name@email.com", "password", Role.admin)
  const academicYear = new AcademicYear("name", new Date("2023-02-17T10:00:00"), new Date("2023-02-17T10:00:00"), true, admin)
  const student = new User("student", "lastname", "name@email.com", "password", Role.student)
  ...
  const admin = new User("admin", "lastname", "name@email.com", "password", Role.admin)
  const academicYear = new AcademicYear("name", new Date("2023-02-17T10:00:00"), new Date("2023-02-17T10:00:00"), true, admin)
  const nonStudent = new User("student", "lastname", "name@email.com", "password", Role.teacher)
  expect(() => academicYear.addStudent(nonStudent)).toThrow(new Error("Cannot add a non student"))
